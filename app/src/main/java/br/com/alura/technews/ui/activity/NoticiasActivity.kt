...
//Ao rotacionar o dispositivo os listener de clique deixam de funcionar e ao excluir uma notícia
//pela tela de visualização não é feito o retorno ao fragment de lista.

private const val TAG_FRAGMENT_VISUALIZA_NOTICIA = "visualizaNoticia"

class NoticiasActivity : AppCompatActivity() {

    private lateinit var fragmentOnAttachListener: FragmentOnAttachListener
    ...
    private fun configuraListenerDosFragments() {
        fragmentOnAttachListener = FragmentOnAttachListener { fragmentManager, fragment ->
            when (fragment) {
    ...
    private fun configuraVisualizaNoticias(fragment: VisualizaNoticiaFragment) {
        ...
        fragment.quandoSelecionaMenuEdicao = { noticiaId->
            abreFormularioEdicao(noticiaId)
        }
    }
